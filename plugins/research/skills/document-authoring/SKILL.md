...
3. **목적과 요지** — 무엇을 설명·기록·비교하거나 주장해야 하는가
...
의사결정**을 기준으로 고른다. 단서가 없으면 `standard`를 명시한다. 임원 보고나 경영 의사결정을 기본 독자로 가정하지 않는다.
...
의사결정 보고서는 결론을 먼저 놓는다. 다음은 그 경우의 기본안이며 기록·교육·참고 문서는
사용자 양식과 독자가 정보를 찾는 순서에 맞게 구성한다.
